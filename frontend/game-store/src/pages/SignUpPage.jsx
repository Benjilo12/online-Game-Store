...
function SignUpPage() {
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8 mt-6 ">
      <motion.div
      ...
      <motion.div
        className="sm:mx-auto sm:w-full sm:max-w-md backdrop-filter backdrop-blur-xl shadow-lg"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.2 }}
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 mt-6">
