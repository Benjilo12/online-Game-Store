...
function Adventurecard({ filteredProducts = [] }) {
  ...
  return (
    <div className="my-8 relative">
      <h2 className="text-2xl font-bold text-white mb-4">Adventure Games</h2>
